...
def calcular_tiempos_en_masa(base, exp_desde, exp_hasta, v_e, v_s):
    ...
    for i, archivo in enumerate(archivos):
        ...
        print(
            f"Test {i} terminado, tiempo total = {tiempo_ejecucion}s, performance = {tiempo_ejecucion / archivo['cantidad'] * 1000000000} ns/videos")
...
def calcular_optimizacion():
    ...
    archivos = generar_archivos(
        BASE, EXPONENTE_DESDE, EXPONENTE_HASTA, VARIACION_E, VARIACION_S)
